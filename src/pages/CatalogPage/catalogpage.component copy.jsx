...
const CatalogPage = ({collections}) => {
  ...
  // console.log(collections.catalog)
  collections.catalog.forEach(x => {
    if(!categoryArray.includes(x.category)){
      categoryArray.push(x.category);
    }
  });
  ...
  return (
    <div className='catalog-container'>
      ...
      <Scroll>
        <ItemList collection={collections.catalog[categories]}/>
      </Scroll>
    </div>
);}
